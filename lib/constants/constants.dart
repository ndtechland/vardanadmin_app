...
class MyTheme {
  ...
  static Color ThemeColors = Color(0xff080838);
  //(0xff27ae61);
  static double defaultPading = 15.0;
  static const Color primaryColorblue = Color(0xff1f08ab);
  static const Color navyblue = Color(0xff080838);
  static const Color navyblue2 = Color(0xff111154);
...
class AppColors {
  ...
  static Color g34 = Color(0xff028a0f);
  static Color g35 = Color(0xff03ac13);
